...
Last verified: 2026-07-31 (Spine shell+mermaid; Lookout research hosts; Cue ASR honesty).
...
| **Spine** | architecture-reader-mcp | Strong/Partial | early | **`ca3f0b3`**: shell extractor; **mermaid** path diagrams; C/C++; core **85**; gate **24/24** | Full Graphify/UA language/UX residual |
...
- **Phase B competitive depth:** partial (shell+mermaid, research hosts, ASR honesty; peer parity residual)
