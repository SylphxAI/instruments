...
Last verified: 2026-07-31 (Phase A checker PASS; Spine docker/sql + overview mermaid).
...
| **Spine** | architecture-reader-mcp | Strong/Partial | early | **`44cb6b7`**: docker/sql extractors; overview/impact/path mermaid; core **91**; gate **24/24** | Full Graphify/UA language/UX residual |
...
- **Phase B competitive depth:** partial (docker/sql, mermaid surfaces, multi-adapter lookout; peer parity residual)
