...
See [CONSTITUTION.md](./CONSTITUTION.md), [NAMING.md](./NAMING.md), [PHASE_TARGETS.md](./PHASE_TARGETS.md), [EVIDENCE_CONTRACT.md](./EVIDENCE_CONTRACT.md), [COMPETITIVE.md](./COMPETITIVE.md), [ACCEPTANCE.md](./ACCEPTANCE.md), [TOOL_SURFACE.md](./TOOL_SURFACE.md), [INSTALL.md](./INSTALL.md), and honest [STATUS.md](./STATUS.md).
