...
| Spine | Understand-Anything / Graphify | Ranked query, path, reverse impact, multi-language, skill | Mermaid path/impact/overview/context_pack; shell/C/SQL/docker/workflows; cycles/orphans |
